...
public class EmployeeManagerAlternativeTest {
	...
	@InjectMocks
	private com.example.EmployeeManager employeeManager;
	...
	@Spy
	private com.example.Employee notToBePaid = new com.example.Employee("1", 1000);

	@Spy
	private com.example.Employee toBePaid = new com.example.Employee("2", 2000);
	...
	public void testPayEmployeesWhenOneEmployeeIsPresent() {
		when(employeeRepository.findAll())
			.thenReturn(asList(new com.example.Employee("1", 1000)));
	...
	public void testPayEmployeesWhenSeveralEmployeeArePresent() {
		when(employeeRepository.findAll())
			.thenReturn(asList(
					new com.example.Employee("1", 1000),
					new com.example.Employee("2", 2000)));
